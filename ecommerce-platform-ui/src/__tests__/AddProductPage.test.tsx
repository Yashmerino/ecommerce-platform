...
describe("Add Product Page Tests", () => {
    const initialState = { jwt: { token: "jwtkey", refreshToken: "refresh123" }, username: { sub: "seller" }, info: { info: { roles: [{ id: 1, name: "SELLER" }], email: null } }, lang: { lang: "ENG" }, theme: { theme: "false" } };
